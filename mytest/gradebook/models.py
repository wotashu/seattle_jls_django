...
class Academicquarters(models.Model):
    ...
    def __unicode__(self):
        ...
        return self.academicquarterid
        return self.academicquarterstartdate
        return self.academicquarterenddate
...
class Academicyears(models.Model):
	...
	return self.academicyearstartdate
	return self.academicyearenddate
	return self.academicyearid
...
class Assignmenttypes(models.Model):
	...
	return self.assignmenttypeid

class Classes(models.Model):
    classid = models.IntegerField(db_column='ClassID', primary_key=True) # Field name made lowercase.
    academicyears_academicyearid = models.IntegerField(db_column='AcademicYears_AcademicYearID') # Field name made lowercase.
    academicquarters_academicquarterid = models.IntegerField(db_column='AcademicQuarters_AcademicQuarterID') # Field name made lowercase.
    courses_courseid = models.IntegerField(db_column='Courses_CourseID') # Field name made lowercase.
    classsection = models.CharField(db_column='ClassSection', max_length=45, blank=True) # Field name made lowercase.
    teachers_teacherid = models.IntegerField(db_column='Teachers_TeacherID') # Field name made lowercase.
    rooms_roomid = models.IntegerField(db_column='Rooms_RoomID', blank=True, null=True) # Field name made lowercase.
    schedules_scheduleid = models.IntegerField(db_column='Schedules_ScheduleID', blank=True, null=True) # Field name made lowercase.
    curriculums_curriculumid = models.IntegerField(db_column='Curriculums_CurriculumID', blank=True, null=True) # Field name made lowercase.
    class Meta:
        managed = False
        db_table = 'Classes'
    def __unicode__(self):
...
class Emergencycontacts(models.Model):
    ...
    addresses_addressid = models.IntegerField(db_column='Addresses_AddressID') # Field name made lowercase.
    class Meta:
        managed = False
    ...
    def __unicode__(self):
        ...
        return self.emergencyemail
        return self.emergencyphone
        return self.addresses_addressid

class Enrollments(models.Model):
    enrollmentid = models.IntegerField(db_column='EnrollmentID', primary_key=True) # Field name made lowercase.
    classes_classid = models.IntegerField(db_column='Classes_ClassID') # Field name made lowercase.
    students_studentid = models.IntegerField(db_column='Students_StudentID') # Field name made lowercase.
    ...
    def __unicode__(self):
        return self.dropstatus
        return self.attendancetotal
        return self.attendancescore
        return self.notes

class Families(models.Model):
    students_studentid = models.IntegerField(db_column='Students_StudentID') # Field name made lowercase.
    parent_parentid = models.IntegerField(db_column='Parent_parentID') # Field name made lowercase.
    class Meta:
        managed = False
        db_table = 'Families'
...
class Grades(models.Model):
    ...
    enrollments_enrollmentid = models.IntegerField(db_column='Enrollments_EnrollmentID') # Field name made lowercase.
    assignmenttypes_assignmenttypeid = models.IntegerField(db_column='AssignmentTypes_AssignmentTypeID') # Field name made lowercase.
...
class Students(models.Model):
    ...
    emergencycontact_emergencyid = models.IntegerField(db_column='EmergencyContact_EmergencyID', blank=True, null=True) # Field name made lowercase.
    class Meta:
        managed = False
        db_table = 'Students'
    def __unicode__(self):
	 ...
	 return self.studentbirthdate
	 return self.studentalternativename
...
class Teachers(models.Model):
    ...
    def __unicode__(self):
        ...
        return self.teacherlastname
        return self.teacherfirstname
        return self.teacheremail
        return self.teacherphone
        return self.address_addressid
