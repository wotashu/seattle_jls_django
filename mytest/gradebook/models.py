...
class Academicquarters(models.Model):
    academicquarterid = models.IntegerField(db_column='AcademicQuarterID',
                                            primary_key=True)  # Field name made lowercase.
    academicquartername = models.CharField(db_column='AcademicQuarterName', max_length=45,
                                           blank=True)  # Field name made lowercase.
    academicquarterstartdate = models.DateField(db_column='AcademicQuarterStartDate', blank=True,
                                                null=True)  # Field name made lowercase.
    academicquarterenddate = models.DateField(db_column='AcademicQuarterEndDate', blank=True,
                                              null=True)  # Field name made lowercase.
...
class Academicyears(models.Model):
    ...
    academicyeartitle = models.CharField(db_column='AcademicYearTitle', max_length=45,
                                         blank=True)  # Field name made lowercase.
    academicyearstartdate = models.DateField(db_column='AcademicYearStartDate', blank=True,
                                             null=True)  # Field name made lowercase.
    academicyearenddate = models.DateField(db_column='AcademicYearEndDate', blank=True,
                                           null=True)  # Field name made lowercase.
...
class Addresses(models.Model):
    ...
    addressstreet1 = models.CharField(db_column='AddressStreet1', max_length=45,
                                      blank=True)  # Field name made lowercase.
    addressstreet2 = models.CharField(db_column='AddressStreet2', max_length=45,
                                      blank=True)  # Field name made lowercase.
    ...
    addresscountry = models.CharField(db_column='AddressCountry', max_length=45,
                                      blank=True)  # Field name made lowercase.
...
class Emergencycontacts(models.Model):
    ...
    emergencyrelationship = models.CharField(db_column='EmergencyRelationship',
                                             max_length=45)  # Field name made lowercase.
    emergencyemail = models.CharField(db_column='EmergencyEmail', max_length=45,
                                      blank=True)  # Field name made lowercase.
    emergencyphone = models.CharField(db_column='EmergencyPhone', max_length=45,
                                      blank=True)  # Field name made lowercase.
    addresses_addressid = models.ForeignKey(Addresses, db_column='Addresses_AddressID', blank=True,
                                            null=True)  # Field name made lowercase.
...
class Assignmenttypes(models.Model):
    ...
    assignmenttitle = models.CharField(db_column='AssignmentTitle', max_length=70,
                                       blank=True)  # Field name made lowercase.
...
class Students(models.Model):
    ...
    studentalternativename = models.CharField(db_column='StudentAlternativeName', max_length=45,
                                              blank=True)  # Field name made lowercase.
    studentbirthdate = models.DateField(db_column='StudentBirthdate', blank=True,
                                        null=True)  # Field name made lowercase.
    ...
    emergencycontact_emergencyid = models.ForeignKey(Emergencycontacts, db_column='EmergencyContact_EmergencyID',
...
class Parents(models.Model):
    ...
    parentfirstname = models.CharField(db_column='ParentFirstname', max_length=45,
                                       blank=True)  # Field name made lowercase.
    parentlastname = models.CharField(db_column='ParentLastname', max_length=45,
                                      blank=True)  # Field name made lowercase.
    parentrelationship = models.CharField(db_column='ParentRelationship', max_length=45,
                                          blank=True)  # Field name made lowercase.
    ...
    address_addressid = models.ForeignKey(Addresses, db_column='Address_AddressID', blank=True,
                                          null=True)  # Field name made lowercase.
...
class Teachers(models.Model):
    ...
    teacherfirstname = models.CharField(db_column='TeacherFirstName', max_length=225,
                                        blank=True)  # Field name made lowercase.
    ...
    address_addressid = models.IntegerField(db_column='Address_AddressID', blank=True,
                                            null=True)  # Field name made lowercase.
...
class Curriculums(models.Model):
    ...
    curriculmdescription = models.CharField(db_column='CurriculmDescription', max_length=45,
                                            blank=True)  # Field name made lowercase.
    curriculumlevel = models.CharField(db_column='CurriculumLevel', max_length=45,
                                       blank=True)  # Field name made lowercase.
    curriculumsyllabus = models.CharField(db_column='CurriculumSyllabus', max_length=45,
                                          blank=True)  # Field name made lowercase.
...
class Classes(models.Model):
    ...
    academicyears_academicyearid = models.ForeignKey(Academicyears,
                                                     db_column='AcademicYears_AcademicYearID')  # Field name made lowercase.
    academicquarters_academicquarterid = models.ForeignKey(Academicquarters,
                                                           db_column='AcademicQuarters_AcademicQuarterID')  # Field name made lowercase.
    ...
    rooms_roomid = models.ForeignKey('Rooms', db_column='Rooms_RoomID', blank=True,
                                     null=True)  # Field name made lowercase.
    schedules_scheduleid = models.ForeignKey('Schedules', db_column='Schedules_ScheduleID', blank=True,
                                             null=True)  # Field name made lowercase.
    curriculums_curriculumid = models.ForeignKey('Curriculums', db_column='Curriculums_CurriculumID', blank=True,
                                                 null=True)  # Field name made lowercase.
    ...
    def __unicode__(self):
        return u'(%s %s) %s %s: %s ' % (
            self.academicyears_academicyearid, self.academicquarters_academicquarterid, self.courses_courseid,
            self.classsection, self.teachers_teacherid)
...
class Enrollments(models.Model):
    ...
    attendancetotal = models.IntegerField(db_column='AttendanceTotal', blank=True,
                                          null=True)  # Field name made lowercase.
    attendancescore = models.IntegerField(db_column='AttendanceScore', blank=True,
                                          null=True)  # Field name made lowercase.
...
class Grades(models.Model):
    ...
    enrollments_enrollmentid = models.ForeignKey(Enrollments,
                                                 db_column='Enrollments_EnrollmentID')  # Field name made lowercase.
    assignmenttypes_assignmenttypeid = models.ForeignKey(Assignmenttypes,
                                                         db_column='AssignmentTypes_AssignmentTypeID')  # Field name made lowercase.
